...
export function buildArticlePrompt(recentTopics, settings = null) {
  ...
  return {
    ...
    user: [
      ...
      'FEATURED IMAGE:\nFor the imagePrompt field, describe one clear clay 3D visual scene in the preferred industry\'s actual business context (a UK electrician\'s van, plumber\'s van and parts, a builder on site, a roofer on scaffolding, a landscaper\'s job) rendered as soft, matte, hand-modelled clay shapes - not a photograph. Show the trade\'s vehicle, tools and materials as tactile clay props, with warm off-white/cream background, near-black subject tones, muted gold accents and soft coral highlights. Specify composition, main subject and supporting objects. The clay scene must contain no written words, no logos, no text overlays. Avoid generic instructions such as "an AI business image" or "a business owner using technology".',
